...
const copy = (lang: Lang) => {
  ...
  return {
    ...
    priceCards: ru
      ? [
          { t: "Очная консультация", v: "10 000 тг", note: "Aiya-Safiya (ЖК Олимп Палас)" },
          { t: "Онлайн консультация", v: "10 000 тг", note: "WhatsApp/видео" },
        ]
      : [
          { t: "Оффлайн консультация", v: "10 000 тг", note: "Aiya-Safiya (ЖК Олимп Палас)" },
          { t: "Онлайн консультация", v: "10 000 тг", note: "WhatsApp/видео" },
        ],
    ...
    address: ru ? "Aiya-Safiya, ЛОР-клиника (ЖК Олимп Палас), ул. Туркестан, 8, ВП: 12А, Астана" : "Aiya-Safiya ЛОР-клиника (ЖК Олимп Палас), Түркістан көш., 8, ВП: 12А, Астана",
    hours: ru ? "Ежедневно 9:00–20:00" : "Күн сайын 9:00–20:00",
    mapBtn: ru ? "Открыть в 2GIS" : "2GIS картадан ашу",
    mapLink: "https://2gis.kz/astana/geo/70000001100398635",
